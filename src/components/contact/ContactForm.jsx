...
const ContactForm = () => {
  ...
  const countries = [
    ...
    "Japan", "South Korea", "Netherlands", "Belgium", "Italy", "Spain",
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                {[
                  { step: "1", title: "We Review", desc: "Our team analyzes your requirements" },
                  { step: "2", title: "We Connect", desc: "A specialist contacts you within 24h" },
                  { step: "3", title: "We Quote", desc: "Receive a detailed proposal" },
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          className="w-full pl-12 pr-10 py-3.5 rounded-xl border-2 border-gray-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all duration-300 focus:outline-none appearance-none bg-white cursor-pointer"
                        >
                  ...
                  <div className="flex items-start space-x-3">
                    <input
                      ...
                      onChange={handleChange}
                      className="w-5 h-5 text-primary-600 border-2 border-gray-300 rounded focus:ring-primary-500 mt-0.5 cursor-pointer"
                    />
                    <label htmlFor="newsletter" className="text-gray-600 text-sm cursor-pointer">
                      Subscribe to our newsletter for industry updates, new products, and exclusive offers. 
